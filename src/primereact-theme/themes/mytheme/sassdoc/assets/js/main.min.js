...
!(function (t) {
  function e(t, n) {
    ...
    var i, o, s;
    for (i = 0, keys = ['sort', 'includeScore', 'shouldSort'], o = keys.length; o > i; i++)
      (s = keys[i]), (this.options[s] = s in n ? n[s] : e.defaultOptions[s]);
    for (i = 0, keys = ['searchFn', 'sortFn', 'keys', 'getFn'], o = keys.length; o > i; i++)
  ...
  var n = function (t, e) {
    if (
      ...
      (this.options.distance = 'distance' in e ? e.distance : n.defaultOptions.distance),
      (this.options.threshold = 'threshold' in e ? e.threshold : n.defaultOptions.threshold),
      (this.options.maxPatternLength = e.maxPatternLength || n.defaultOptions.maxPatternLength),
  ...
  (n.defaultOptions = { location: 0, distance: 100, threshold: 0.6, maxPatternLength: 32 }),
    ...
    (n.prototype.search = function (t) {
      ...
      for (
        ...
        for (i = 0, o = d; o > i; )
          this._bitapScore(e, l + o) <= u ? (i = o) : (d = o), (o = Math.floor((d - i) / 2 + i));
        for (
          d = o,
            s = Math.max(1, l - o + 1),
          ...
          if (
            ...
            (a[n] =
              0 === e
                ? ((a[n + 1] << 1) | 1) & p
                : (((a[n + 1] << 1) | 1) & p) | (((h[n + 1] | h[n]) << 1) | 1) | h[n + 1]),
...
(function ($, global) {
  ...
  Sidebar.prototype.loadToggle = function () {
    $('<span />', { class: 'layout-toggle', html: '&times;', 'data-alt': '&#8594;' }).appendTo(
      $('.header')
    );
...
(function ($, global) {
  ...
  var App = function (conf) {
    this.conf = $.extend(
      { search: new global.Search(), sidebar: new global.Sidebar(), init: true },
      conf || {}
    );
